...
tf.app.flags.DEFINE_string('checkpoint_dir','/proj/NIRAL/users/siyangj/model_11012016/models/1/11021309', "Output folder where training logs and models are dumped.")
