...
tf.app.flags.DEFINE_integer('batch_size', 4, "Number of samples per batch.")
...
tf.app.flags.DEFINE_string('checkpoint_dir','/proj/NIRAL/users/siyangj/model_11012016/models/1', "Output folder where training logs and models are dumped.")
