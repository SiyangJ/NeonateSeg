...
tf.app.flags.DEFINE_integer('batches_one_image', 10, "how many batches extraction from a 3D image for training")
...
tf.app.flags.DEFINE_string('checkpoint_dir','/proj/NIRAL/users/siyangj/model_11012016/models/2/11021309', "Output folder where training logs and models are dumped.")
...
tf.app.flags.DEFINE_string('hdf5_validation_list_path','/proj/NIRAL/users/siyangj/myData/BernNet/hdf5/test_data.list', "Store the training hdf5 file list.")
