...
def train_model(train_data):
    ...
    if FLAGS.restore_from_last:
        saver = tf.train.Saver()
        # model_path = os.path.join(FLAGS.checkpoint_dir, 'snapshot_10000')
    ...
    while not done:
        ...
        feed_dict = {td.tf_t1_input : train_input1, td.tf_t2_input : train_input2, \
                            td.tf_dm_input1:dm_input1, td.tf_dm_input2:dm_input2, td.tf_dm_input3:dm_input3, \
                            td.tf_label: train_label, td.learning_rate : lrval}
