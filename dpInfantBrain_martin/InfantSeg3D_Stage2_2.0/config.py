...
tf.app.flags.DEFINE_bool('augmentation', ARGS.getboolean('augmentation'), 
                         "whether to do augmentation in Training.")
...
tf.app.flags.DEFINE_float('L2_loss_weight', ARGS.getfloat('L2_loss_weight'), 
                          "loss weight of main classifier")
tf.app.flags.DEFINE_float('reject_T', ARGS.getfloat('reject_T'), 
                          "remove isolated regions, when the area is less then reject_T")
...
tf.app.flags.DEFINE_string('nifti_dir', ARGS['nifti_dir'],
                           "Store the training hdf5 file list.")
